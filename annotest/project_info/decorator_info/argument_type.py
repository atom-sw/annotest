...
class NpArrays(ArgumentTypeInformation):
    def __init__(
        ...
        ] = constant.ArgumentTypeInformation.NpArrays.shape,
    ):
...
class Tuples(ArgumentTypeInformation):
    def __init__(self, args: List[ArgumentTypeInformation]):
        self.args = args
...
class Dictionaries(ArgumentTypeInformation):
    def __init__(
        ...
        self.min_size = (
            constant.ArgumentTypeInformation.Dictionaries.min_size
        ) = min_size
        self.max_size = (
            constant.ArgumentTypeInformation.Dictionaries.max_size
        ) = max_size


class ComplicatedObject(ArgumentTypeInformation):
    def __init__(self, generator: ast.expr):
